  ...
  const [modalIsOpen1, setModalIsOpen1] = useState(false)
    return (
      <div className="project">
        ...
        <h1>Sentinel</h1>
        <br></br>
        <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-evenly', width: '60vw'}}>
            <img src='./images/sentinel/screens/screen.png' style={{maxHeight: '40vh'}}></img>
            <img src='./images/sentinel/lock.png' style={{maxHeight: '40vh'}}></img>
            <img src='./images/sentinel/tracker.png' style={{maxHeight: '40vh'}}></img>
        </div>
        <img src='./images/sentinel/logo.png' style={{maxHeight: '15vh'}}></img>
        <br></br>
      ...
      <body class="description">
        <article>
          ...
          <p>
            ...
            <p><img src='./images/sentinel/screens/compscreen.png' style={{maxHeight: '40vh', float: 'right'}}></img>The Sentinel bike lock system takes a multi-step approach to achieve this goal:<br></br><br></br>
        ...
        <article>
          ...
          <img src="./images/sentinel/icons/q.png" className="icon"></img>
            <div style={{display: 'flex', flexDirection: 'column', justifyContent: 'flex-start'}}>
              <img src='./images/sentinel/proarrow.svg'></img>
            ...
            <img src="./images/sentinel/icons/r.png" className="icon"></img>
            <div style={{display: 'flex', flexDirection: 'column', justifyContent: 'flex-start'}}>
              <img src='./images/sentinel/proarrow1.svg'></img>
            ...
            <img src="./images/sentinel/icons/i.svg" className="icon"></img>
            <div style={{display: 'flex', flexDirection: 'column', justifyContent: 'flex-start'}}>
              <img src='./images/sentinel/proarrow2.svg'></img>
            ...
            <img src="./images/sentinel/icons/p.png" className="icon"></img>
            <div style={{display: 'flex', flexDirection: 'column', justifyContent: 'flex-start'}}>
              <img src='./images/sentinel/proarrow4.svg'></img>
              <p className="link"><a  onClick={()=>scroll('#hf')}>Hi-Fidelity Mockups</a></p>
            </div>
            <img src="./images/sentinel/icons/f.png" className="icon"></img>
          </div>
          <br></br><br></br>
        ...
        <article>
          ...
          <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-evenly'}}>
            <Screen img="./images/sentinel/team/tn.webp" maxHeight="30vh" cap="I'm Travis Neils a sophomore in HCDE. I gained a good introduction into design methods from this class.I don't eat shaving cream because I don't like the taste - neilstra@uw.edu"></Screen>
            <Screen img="./images/sentinel/team/ca.webp" maxHeight="30vh" cap=" I'm Carl Arenas, a senior studying Psychology. I enjoy listening to podcasts and playing videogames - arenascarl17@gmail.com"></Screen>
            <Screen img="./images/sentinel/team/nt.webp" maxHeight="30vh" cap="I'm a Nadir a sophomore in HCDE. I'm an international student from Karachi, Pakistan. I enjoyed learning how to make prototypes in this class! - nadirkt@uw.edu"></Screen>
            <Screen img="./images/sentinel/team/sy.webp" maxHeight="30vh" cap="I'm Samantha, a senior majoring in Public Health and minoring in Gender, Women, and Sexuality Studies. I’m doing Teach for America in New York City after I graduate and I ran the Seattle Marathon this past fall - samantha.yi128@gmail.com"></Screen>
          </div>
        </article>
        <article>
          <h2>Context & Role</h2>
        ...
        <article>
          <h2><img src="./images/sentinel/icons/r.png" className="icon"></img> Research</h2>
          ...
          <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-evenly', alignItems: "flex-start"}}>
            <img className ="scale" src='./images/sentinel/interviews/j.svg' style={{maxHeight: '45vh'}}></img>
            <img className ="scale" src='./images/sentinel/interviews/a.svg' style={{maxHeight: '45vh'}}></img>
            <img className ="scale" src='./images/sentinel/interviews/i.svg' style={{maxHeight: '50vh'}}></img>
            <img className ="scale" src='./images/sentinel/interviews/b.svg' style={{maxHeight: '55vh'}}></img>
          </div>
          ...
          <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-evenly'}}>
            <div style={{display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', maxWidth: '20vw'}}>
              <img src="./images/sentinel/compan/sherl1.JPG"style={{maxHeight: '15vh', maxWidth: '30vh'}}></img>
              <img src="./images/sentinel/compan/sherl2.JPG"style={{maxHeight: '15vh', maxWidth: '30vh'}}></img>
              <p><b>Sherlock - </b>A cylindrical GPS tracker that is hidden in the handlebars of the bike</p>
            </div>
            <div style={{display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', maxWidth: '20vw'}}>
              <img src="./images/sentinel/compan/bitlock.png"style={{maxHeight: '30vh', maxWidth: '50vh'}}></img>
              <p><b>Bitlock - </b>A keyless smart bike lock that can be tracked and unlocked via phone app</p>
           </div>
           <div style={{display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', maxWidth: '20vw'}}>
              <img src="./images/sentinel/compan/rs.png"style={{maxHeight: '30vh', maxWidth: '50vh'}}></img>
          ...
          <Carousel>
            <div>
              <img src="./images/sentinel/personas/k.png" alt="Persona for Karen, the commuter."></img>
            </div>
            <div>
              <img src="./images/sentinel/personas/t.png" alt="Persona for Timothy, the recretational user."></img>
            </div>
          </Carousel>
          ...
          <img src="./images/sentinel/journey.webp" alt="Commuter Journey Map" style={{float: 'center'}}></img>
        </article><hr></hr>
        <article>
          <h2><img src="./images/sentinel/icons/i.svg" className="icon"></img> Design</h2><br></br>
          ...
          <div style={{display: 'flex', justifyContent: 'center'}} onMouseEnter={() => scale('#story')} onMouseLeave={()=> scale('#story')}>
            `<div id="story" style={{height: '50%', width: '50%'}} className='scaled'  > 
              <Carousel>
                <div style={{margin: 'auto'}}>
                  <img  src="./images/sentinel/storyboards/theftstory.jpg" alt="Storyboard showing bike theft"></img>
                  <p className="legend"><b>Theft Storyboard</b> - Designer: Nadir</p>
                </div>
                <div style={{margin: 'auto'}}>
                  <img src="./images/sentinel/storyboards/rackstory.jpg" alt="Storyboard showing navigation"></img>
                  <p className="legend"><b>Navigating to bike rack</b> - Designer: Carl</p>
                </div>
                <div style={{margin: 'auto'}}>
                  <img  src="./images/sentinel/storyboards/pumpstory.jpg" alt="Storyboard showing navigation"></img>
                  <p className="legend"><b>Uploading resources: bike pump</b> - Designer: Nadir</p>
                </div>
                <div style={{margin: 'auto'}}>
                  <img  src="./images/sentinel/storyboards/rackstory2.jpg" alt="Storyboard showing navigation"></img>
                  <p className="legend"><b>Navigating to bike rack</b> - Designer: Carl</p>
                </div>
                <div style={{margin: 'auto'}}>
                  <img src="./images/sentinel/storyboards/rackstory3.jpg" alt="Storyboard showing navigation"></img>
                  <p className="legend"><b>Navigating to bike rack</b> - Designer: Travis</p>
                </div>
                <div style={{margin: 'auto'}}>
                  <img  src="./images/sentinel/storyboards/rackstory4.jpg" alt="Storyboard showing navigation"></img>
          ...
          <div style={{margin: 'auto'}}>
            <img src="./images/sentinel/infoarch.jpg" alt="Poolbuddy information architecture" style={{maxWidth: "75vw", height: 'auto'}}></img>
          </div>
          <hr></hr>
        </article>
        <article>
          <h2><img src="./images/sentinel/icons/p.png" className="icon"></img>Prototype</h2>
          ...
          <div style={{display: 'flex', flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-evenly'}}>
            <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', maxWidth: '65vw', minWidth: '20vw'}}>
              ...
              <div style={{display: 'flex', flexDirection: 'row', justifyContent:'flex-start', flexWrap: 'wrap'}} >
                <Screen maxHeight='40vh' img="./images/sentinel/pp/t1/0.JPG" cap="User grants permissions" onLoad={() =>show(".t1") }></Screen>
                <Screen maxHeight='40vh' className="t1" img="./images/sentinel/pp/t1/1.JPG" cap="Pairing lock with phone"></Screen>
                <Screen maxHeight='40vh' className="t1" img="./images/sentinel/pp/t1/2.JPG" cap="Pairing complete"></Screen>
                <Screen maxHeight='40vh' className="t1" img="./images/sentinel/pp/t1/3.JPG" cap="User completes login info"></Screen>
                <Screen maxHeight='40vh' className="t1" img="./images/sentinel/pp/t1/4.JPG" cap="User agrees to a simplified T&C"></Screen>
                <Screen maxHeight='40vh' className="t1" img="./images/sentinel/pp/t1/5.JPG" cap="User adds their preferences"></Screen>
                <Screen maxHeight='40vh' className="t1" img="./images/sentinel/pp/t1/6.JPG" cap="User selects back up pin code"></Screen>
            ...
            <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center',  maxWidth: '65vw', minWidth: '20vw'}}>
              ...
              <div style={{display: 'flex', flexDirection: 'row', justifyContent:'flex-start', flexWrap: 'wrap'}} >
                <Screen maxHeight='40vh' img="./images/sentinel/pp/t2/0.JPG" cap="Map button navigates to map screen." onLoad={() =>show(".t2") }></Screen>
                <Screen maxHeight='40vh' className="t2" img="./images/sentinel/pp/t2/1.JPG" cap="Tapping on a bike rack will give information."></Screen>
                <Screen maxHeight='40vh' className="t2" img="./images/sentinel/pp/t2/2.JPG" cap="Holding on the screen will bring up a list view of racks."></Screen>
                <Screen maxHeight='40vh' className="t2" img="./images/sentinel/pp/t2/3.JPG" cap="Filtering bike racks by type."></Screen>
                <Screen maxHeight='40vh' className="t2" img="./images/sentinel/pp/t2/4.JPG" cap="Filtering bike racks by type."></Screen>
                <Screen maxHeight='40vh' className="t2" img="./images/sentinel/pp/t2/5.JPG" cap="Selecting a bike rack to navigate to"></Screen>
                <Screen maxHeight='40vh' className="t2" img="./images/sentinel/pp/t2/6.JPG" cap="Navigation"></Screen>
                <Screen maxHeight='40vh' className="t2" img="./images/sentinel/pp/t2/8.JPG" cap="Navigation complete. User can save rack."></Screen>
                <Screen maxHeight='40vh' className="t2" img="./images/sentinel/pp/t2/9.JPG" cap="Saved rack is starred."></Screen>
            ...
            <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', maxWidth: '65vw', minWidth: '20vw'}}>
              ...
              <div style={{display: 'flex', flexDirection: 'row', justifyContent:'flex-start', flexWrap: 'wrap'}} >
                <Screen maxHeight='40vh' img="./images/sentinel/pp/t2/0.JPG" cap="User is on map screen at an unindexed location." onLoad={() =>show(".t3") }></Screen>
                <Screen maxHeight='40vh' className="t3" img="./images/sentinel/pp/t3/2.JPG" cap="User presses add button to add new location"></Screen>
                <Screen maxHeight='40vh' className="t3" img="./images/sentinel/pp/t3/4.JPG" cap="Data input: Location pin drop"></Screen>
                <Screen maxHeight='40vh' className="t3" img="./images/sentinel/pp/t3/6.JPG" cap="Data input: Amenities"></Screen>
                <Screen maxHeight='40vh' className="t3" img="./images/sentinel/pp/t3/7.JPG" cap="Data input: Crowd reporting"></Screen>
                <Screen maxHeight='40vh' className="t3" img="./images/sentinel/pp/t3/8.JPG" cap="Submission completed"></Screen>
          ...
          <div style={{display: 'flex', flexDirection:'row', justifyContent: 'space-between'}}>
            ...
            <Screen img="./images/sentinel/test.jpg" cap="Testing our paper prototype"></Screen>
          </div>
          ...
          <div style={{width: "35vw", marginBottom:"5vh"}}>
            ...
            <Screen img="./images/sentinel/pp/t1/6.JPG" cap="Problem screen"></Screen>
          ...
          <div style={{width: "35vw", marginBottom:"5vh"}}>
            ...
            <Screen img="./images/sentinel/pp/t2/3.JPG" cap="Problem screen"></Screen>
          ...
          <div style={{width: "35vw", marginBottom:"5vh"}}>
            ...
            <Screen img="./images/sentinel/pp/t2/4.JPG" cap="Problem screen"></Screen>
          ...
          <div style={{width: "35vw", marginBottom:"5vh"}}>
            ...
            <Screen img="./images/sentinel/pp/t2/0.JPG" cap="Problem screen"></Screen>
          ...
          <Carousel>
                <div style={{margin: 'auto',width: "800px", height: "600px"}}>
                  <img  src="./images/sentinel/wireframes/0.jpg" alt="Setup wireframe"></img>
                </div>
                <div style={{margin: 'auto',width: "800px", height: "600px"}}>
                  <img src="./images/sentinel/wireframes/1.jpg" alt="Lockscreen wireframe"></img>
                </div>
                <div style={{margin: 'auto',width: "800px", height: "600px"}}>
                  <img  src="./images/sentinel/wireframes/2.jpg" alt="Map wireframe"></img>
                </div>
                <div style={{margin: 'auto', width: "800px", height: "600px"}}>
                  <img  src="./images/sentinel/wireframes/3.jpg" alt="Map wireframe"></img>
                </div>
                <div style={{margin: 'auto', width: "800px", height: "600px"}}>
                  <img  src="./images/sentinel/wireframes/4.jpg" alt="Add location wireframe"></img>
                </div>
                <div style={{width: "800px", margin: 'auto', height: "600px"}}>
                  <img  src="./images/sentinel/wireframes/5.jpg" alt="Add location wireframe"></img>
                </div>
                <div style={{margin: 'auto', width: "800px", height: "600px"}}>
                  <img  src="./images/sentinel/wireframes/6.jpg" alt="Key path set up"></img>
                </div>
                <div style={{margin: 'auto', width: "800px", height: "600px"}}>
                  <img  src="./images/sentinel/wireframes/7.jpg" alt="Key path add location"></img>
                </div>
                <div style={{margin: 'auto', width: "800px", height: "600px"}}>
                  <img  src="./images/sentinel/wireframes/8.jpg" alt="Key path navigation"></img>
                </div>
                <div style={{margin: 'auto', width: "800px", height: "600px"}}>
                  <img  src="./images/sentinel/wireframes/9.jpg" alt="Key path theft"></img>
                </div>
              </Carousel>
        ...
        <article>
        <h2><img src="./images/sentinel/icons/f.png" className="icon"></img>Finalize</h2>
        ...
        <Carousel>
                <div style={{margin: 'auto',width: "800px", height: "600px"}}>
                  <img  src="./images/sentinel/hifi/0.png" alt="Setup wireframe"></img>
                </div>
                <div style={{margin: 'auto',width: "800px", height: "600px"}}>
                  <img  src="./images/sentinel/hifi/1.png" alt="Setup wireframe"></img>
                </div>
                <div style={{margin: 'auto',width: "800px", height: "600px"}}>
                  <img  src="./images/sentinel/hifi/2.png" alt="Setup wireframe"></img>
                </div>
                <div style={{margin: 'auto',width: "800px", height: "600px"}}>
                  <img  src="./images/sentinel/hifi/3.png" alt="Setup wireframe"></img>
                </div>
                <div style={{margin: 'auto',width: "800px", height: "600px"}}>
                  <img  src="./images/sentinel/hifi/4.png" alt="Setup wireframe"></img>
                </div>
                <div style={{margin: 'auto',width: "800px", height: "600px"}}>
                  <img  src="./images/sentinel/hifi/5.png" alt="Setup wireframe"></img>
                </div>
                <div style={{margin: 'auto',width: "800px", height: "600px"}}>
                  <img  src="./images/sentinel/hifi/6.png" alt="Setup wireframe"></img>
                </div>
                <div style={{margin: 'auto',width: "800px", height: "600px"}}>
                  <img  src="./images/sentinel/hifi/7.png" alt="Setup wireframe"></img>
                </div>
                <div style={{margin: 'auto',width: "800px", height: "600px"}}>
                  <img  src="./images/sentinel/hifi/8.png" alt="Setup wireframe"></img>
                </div>
                <div style={{margin: 'auto',width: "800px", height: "600px"}}>
                  <img  src="./images/sentinel/hifi/9.png" alt="Setup wireframe"></img>
                </div>
        </Carousel>
        </article>
        <article>
